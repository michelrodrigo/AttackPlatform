...
svg_path = os.path.join(os.getcwd(), "assets", "background1.html")
    ...
    html.Div([
        ...
        html.Div([
            html.Iframe(
                ...
                id="svg-container",
                style={"width": "300px", "height": "400px", "border": "none", "position": "relative"}
            ),
            ...
            html.Div(
                ...
                style={
                    "width": "200px",
                    "height": "0px",  # Inicia vazio
                    "background-color": "blue",
                    "position": "absolute",
                    "left": "50px",  # Ajuste conforme o tanque no SVG
                    "bottom": "50px"  # Alinha com a base do tanque
                }
            ),
        ...
        ], style={"position": "relative", "width": "300px", "height": "400px", "margin": "auto"}),
