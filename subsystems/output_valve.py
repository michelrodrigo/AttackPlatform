...
# creates the states of output valve
s_output_valve_closed = State("closed", marked=True)
s_output_valve_open = State("open", marked=False)
...
class OutputValve(threading.Thread):
    ...
    def open(self):
        ...
        if print_output_valve:
            print(CSUB+"Output Valve open."+CEND)
